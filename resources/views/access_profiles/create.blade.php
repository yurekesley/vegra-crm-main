<x-app-layout>
    ...
    <div class="overflow-x-auto bg-white border border-gray-300 rounded-lg shadow-lg">
        <form action="{{ route('access_profiles.store') }}" method="POST">
            @csrf
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 md:col-span-1">
                            ...
                            <select id="location" name="active" id="user_status"
                                ...
                                <option @if (old('active')) selected @endif value="true">Ativo</option>
                                <option @if (!old('active')) selected @endif value="false">Inativo</option>
                            </select>
                            @error('active')
                                <small class="text-red-700 font-sm">*{{ $message }}</small>
                            @enderror
