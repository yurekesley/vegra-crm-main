                            ...
                            <tr>
                                <td class="header"
                                    ...
                                    <a href="{{ env('APP_URL') }}"
                                        ...
                                        target="_blank">
                                        <img src="{{ env('APP_URL') }}/images/logo-vegra-vermelho.png"
                                            class="logo" alt="Data Vegra"
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; max-width: 100%; border: none;"></a>
                                </td>
                            </tr>
                                            ...
                                            <tr>
                                                <td class="content-cell"
                                                    ...
                                                    <p
                                                        ...
                                                        Por favor clique no botão a seguir para trocar sua senha.</p>
                                                    <table class="action" align="center" width="100%"
                                                                                            ...
                                                                                            <tr>
                                                                                                <td
                                                                                                    ...
                                                                                                    <a href="{{ $url }}"
                                                                                                        ...
                                                                                                        target="_blank"
                                                                                                        rel="noopener"
                                                                                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -webkit-text-size-adjust: none; border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: rgb(185, 28, 28); border-bottom: 8px solid rgb(185, 28, 28); border-left: 18px solid rgb(185, 28, 28); border-right: 18px solid rgb(185, 28, 28); border-top: 8px solid rgb(185, 28, 28);">Trocar senha</a>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>
                                                    ...
                                                    <p
                                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                        Se você não realizou esta solicitação, nenhuma ação é necessária.
                                                    </p>
                                                    <p
                                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                        Att,<br>
                                                            ...
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Se você tiver problemas ao clicar no botão
                                                                        acima, copie e cole o link a seguir em seu
                                                                        navegador: <span class="break-all"
                                            ...
                                            <tr>
                                                <td class="content-cell" align="center"
                                                    ...
                                                    <p
                                                        ...
                                                        © {{ date('Y') }} Vegra. Todos os direitos reservados.</p>
