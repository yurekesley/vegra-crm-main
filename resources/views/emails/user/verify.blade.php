                                            ...
                                            <tr>
                                                <td class="content-cell"
                                                    ...
                                                    <p
                                                        ...
                                                        Por favor clique no botão a seguir para confirmar seu cadastro
                                                        no Data Vegra.</p>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td
                                                                                                    ...
                                                                                                    <a href="{{ $url }}"
                                                                                                        ...
                                                                                                        target="_blank"
                                                                                                        rel="noopener"
                                                                                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -webkit-text-size-adjust: none; border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: rgb(185, 28, 28); border-bottom: 8px solid rgb(185, 28, 28); border-left: 18px solid rgb(185, 28, 28); border-right: 18px solid rgb(185, 28, 28); border-top: 8px solid rgb(185, 28, 28);">Confirmar
                                                                                                        email</a>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </tbody>
