                                ...
                                <ol role="list"
                                    ...
                                    <li class="relative md:flex-1 md:flex">
                                        ...
                                        <p href="#" class="flex items-center w-full group">
                                            <span class="flex items-center px-6 py-4 text-sm font-medium">
                                                ...
                                                <span class="ml-4 text-sm font-bold text-red-700">Código de participação</span>
                                            </span>
                                        </p>
                                    ...
                                    <li class="relative hidden md:flex-1 md:flex md:visible">
                                        ...
                                        <p href="#" class="flex items-center px-6 py-4 text-sm font-medium"
                                            ...
                                            <span
                                                class="ml-4 text-sm font-medium text-gray-500 group-hover:text-gray-900">Confirmação do código</span>
                                        </p>
                                    ...
                                    <li class="relative hidden md:flex-1 md:flex md:visible">
                                        ...
                                        <p href="#" class="flex items-center px-6 py-4 text-sm font-medium"
                                            ...
                                            <span
                                                class="ml-4 text-sm font-medium text-gray-500 group-hover:text-gray-900">Seleção de unidade</span>
                                        </p>
                                    ...
                                    <li class="relative hidden md:flex-1 md:flex md:visible">
                                        ...
                                        <p href="#" class="flex items-center group">
                                            <span class="flex items-center px-6 py-4 text-sm font-medium">
                                                ...
                                                <span
                                                    class="ml-4 text-sm font-medium text-gray-500 group-hover:text-gray-900">Enviar proposta</span>
                                            </span>
                                        </p>
                                    </li>
                                </ol>
                            ...
                            <div class="overflow-hidden bg-white rounded-lg shadow-md">
                                <div class="p-6">
                                    ...
                                    <p class="text-lg text-justify text-gray-500">
                                        {!! $product->welcome_text !!}
                                    </p>
                                    <hr class="mt-4 mb-4" />
                                    <p class="text-lg text-justify text-gray-500">
                                        {!! $product->qualification_text !!}
                                    </p>
                                    <hr class="mt-4" />
                                </div>
                                <form method="POST"
                                    action="{{ $prospect == null ? route('proposals.registration.check-code', [$product->id, 'timestamp' => time()]) : route('proposals.registration.mirror', ['product' => $product->id, 'code' => $prospect->code->id]) }}" class="w-full">
                                    @csrf
                                    <div class="p-6">
                                        <div class="grid grid-cols-12 gap-4 mb-4">
                                            <div class="col-span-12 md:col-span-3 md:col-start-3">
                                                ...
                                                <x-input id="code" class="block w-full mt-1 text-center uppercase disabled:bg-gray-200 disabled:text-gray-500" type="text"
                                                    name="code" :value="old('code') ?? $prospect?->code?->code" maxlength="8" />
                                            </div>
                                            <div class="col-span-12 md:col-span-3">
                                                <h1 class="mt-4 text-lg font-bold text-left text-gray-700 uppercase">
                                                    {{ __('Primeiro nome') }}
                                                </h1>
                                                <x-input id="name" class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500" type="text"
                                                    name="name" :value="$prospect?->name" disabled />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1 class="mt-4 text-lg font-bold text-left text-gray-700 uppercase">
                                                    {{ __('Renda do proponente') }}
                                                </h1>
                                                <x-input id="incoming" class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500" type="text"
                                                    name="incoming" :value="$prospect != null ? 'R$ ' . $prospect->total_incoming : ''" disabled />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="px-4 py-8 text-center bg-gray-50 sm:px-6">
                                        ...
                                        <button type="submit"
                                            ...
                                            {{ $prospect == null ? __('Verificar código') : __('Abrir espelho de vendas digital') }}
                                        </button>
