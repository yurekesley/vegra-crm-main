                ...
                <div class="grid items-center grid-cols-12 gap-4">
                    <div class="grid grid-cols-1 col-span-12 gap-4 mt-4 md:col-span-10 md:col-start-2">
                        ...
                        <section aria-labelledby="section-1-title">
                            ...
                            <form method="POST"
                                action="{{ route('proposals.registration.fill_proposal.store', ['proposal' => $proposal->id]) }}"
                                class="w-full">
                                @csrf
                                <div class="overflow-hidden bg-white rounded-lg shadow-md">
                                    <div class="px-6 pt-6">
                                        <div class="flex justify-center px-4 mx-auto mb-8 sm:px-6 lg:px-8">
                                            <img src="{{ $proposal->product->logo_url }}"
                                                alt="Logo {{ $proposal->product->name }}">
                                        </div>
                                        <h1 class="mt-4 text-lg font-bold text-center text-gray-700 uppercase">
                                            {{ __('Proposta') }}
                                        </h1>
                                        @if ($proposal->unit->unit_group->delivery_forecast != null)
                                            <h1 class="mt-4 font-bold text-center text-gray-500 text-md">
                                                {{ __('Previsão de entrega ') . $proposal->unit->unit_group->delivery_forecast?->format('m/Y') }}
                                            </h1>
                                        @endif

                                        <hr class="col-span-6 mt-4 mb-2" />
                                        <div class="grid grid-cols-12 gap-4 mb-4">
                                            <div class="col-span-12">
                                                <h1 class="mt-4 text-lg font-bold text-left text-gray-500">
                                                    {{ __('Unidade: ') .$proposal->unit->unit_group->getTranslatedType() .' ' .$proposal->unit->unit_group->number .' / ' .$proposal->unit->number }}
                                                </h1>
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1 class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                    {{ __('Valor da unidade') }}
                                                </h1>
                                                <x-input id="price"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="text" name="price" disabled
                                                    :value="'R$ ' . number_format( $proposal->product->commission_payer == 'incorporator' ? $proposal->unit->price : ($proposal->unit->price -  ($proposal->unit->price * ($proposal->product->partner_commission_value / 100))) , 2, ',', '.')" />
                                            </div>
                                            @if ($proposal->product->show_commission_on_proposals)
                                                <div class="col-span-12 md:col-span-2">
                                                    <h1
                                                        class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                        {{ __('Valor da comissão') }}
                                                    </h1>
                                                    <x-input id="commission"
                                                        class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500"
                                                        type="text" name="commission"
                                                        :value="'R$ ' . number_format($proposal->unit->price * ($proposal->product->partner_commission_value / 100), 2, ',', '.')"
                                                        disabled />
                                                </div>
                                            @endif
                                            <div class="col-span-6 md:col-span-3">
                                                <h1 class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                    {{ __('Modo de pagamento') }}
                                                </h1>
                                                <select name="payment_method" id="payment_method"
                                                    ...
                                                    <option disabled selected value="">Selecione um modelo de pagamento
                                                    </option>
                                                    <option {{ old('payment_method') == 'cash' ? 'selected' : '' }}
                                                        value="cash">{{ _('À vista') }}</option>
                                                    @if ($proposal->unit->isTableProposalAvailable())
                                                        <option
                                                            {{ old('payment_method') == 'table' ? 'selected' : '' }}value="table">
                                                            {{ _('Na tabela') }}</option>
                                                    @endif
                                                    <option
                                                        {{ old('payment_method') == 'custom' ? 'selected' : '' }}value="custom">
                                                        {{ _('Personalizado') }}</option>
                                                </select>
                                        ...
                                        <hr class="col-span-6 mt-6 mb-2" />
                                    </div>
                                    <div class="px-6 pt-2 pb-6" id="div_cash" style="display: none;">
                                        <div class="grid grid-cols-12 gap-4 mb-4">
                                            <div class="col-span-12">
                                                <h1 class="mt-4 text-lg font-bold text-left text-gray-700 uppercase">
                                                    {{ __('Fluxo pré-chaves') }}
                                                </h1>
                                            </div>
                                            <div class="col-span-12">
                                                <h1 class="mt-4 font-bold text-left text-gray-500 uppercase text-md">
                                                    {{ __('Ato') }}
                                                </h1>
                                            </div>
                                            <div class="col-span-12 md:col-span-1">
                                                ...
                                                <x-input id="cash_installments"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="text" name="cash_installments" disabled :value="1" />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1 class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                    {{ __('Valor') }}
                                                </h1>
                                                <x-input id="cash_value"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="text" name="cash_value" disabled
                                                    :value="'R$ ' . number_format( $proposal->product->commission_payer == 'incorporator' ? $proposal->unit->price : ($proposal->unit->price -  ($proposal->unit->price * ($proposal->product->partner_commission_value / 100))), 2, ',', '.')" />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1 class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                ...
                                                <x-input id="cash_date"
                                                    class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="text" name="cash_date"
                                                    :value="$proposal->unit->pre_keys_spot_month?->format('m/Y')"
                                                    disabled />
                                            </div>
                                            <div class="col-span-12">
                                                <h1 class="mt-6 font-bold text-left text-gray-500 uppercase text-md">
                                                    {{ __('Valor total do fluxo pré-chaves') }}
                                                </h1>
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1 class="mt-2 text-sm font-bold text-justify text-gray-700 uppercase">
                                                    {{ __('Valor total de pré-chaves') }}
                                                </h1>
                                                <x-input id="cash_value"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="text" name="cash_value" disabled
                                            ...
                                            <hr class="col-span-12 mt-6 mb-2" />
                                        </div>
                                    </div>
                                    <div class="px-6 pt-2 pb-6" id="div_table" style="display: none;">
                                        <div class="grid grid-cols-12 gap-4 mb-4">
                                            <div class="col-span-12">
                                                <h1 class="mt-4 text-lg font-bold text-left text-gray-700 uppercase">
                                                    {{ __('Fluxo pré-chaves') }}
                                            ...
                                            @if ($proposal->unit->inflow > 0)
                                                <div class="col-span-12">
                                                    <h1
                                                        class="mt-4 font-bold text-left text-gray-500 uppercase text-md">
                                                        {{ __('Ato') }}
                                                    </h1>
                                                </div>
                                                <div class="col-span-12 md:col-span-1">
                                                ...
                                                <div class="col-span-12 md:col-span-2">
                                                    ...
                                                    <x-input id="cash_value"
                                                        class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                        type="text" name="cash_value" disabled
                                                        :value="'R$ ' . number_format($proposal->unit->inflow, 2, ',', '.')" />
                                                </div>
                                                <div class="col-span-12 md:col-span-2">
                                                    <h1
                                                        class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                            ...
                                            @if ($proposal->unit->pre_keys_monthly_qty > 0)
                                                ...
                                                <div class="col-span-12 md:col-span-1">
                                                    ...
                                                    <x-input id="cash_installments"
                                                        class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                        type="text" name="cash_installments" disabled
                                                        :value="$proposal->unit->pre_keys_monthly_qty" />
                                                </div>
                                                <div class="col-span-12 md:col-span-2">
                                                    <h1
                                                        class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                    ...
                                                    <x-input id="cash_value"
                                                        class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                        type="text" name="cash_value" disabled
                                                        :value="'R$ ' . number_format($proposal->unit->pre_keys_monthly_value, 2, ',', '.')" />
                                                </div>
                                                <div class="col-span-12 md:col-span-2">
                                                    <h1
                                                        class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                    ...
                                                    <x-input id="cash_date"
                                                        class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500"
                                                        type="text" name="cash_date"
                                                        :value="$proposal->unit->pre_keys_monthly_start?->format('m/Y')"
                                                        disabled />
                                                </div>
                                            @endif
                                            @if ($proposal->unit->getIntermediateQty() > 0)
                                                <div class="col-span-12">
                                                    <h1
                                                        class="mt-4 font-bold text-left text-gray-500 uppercase text-md">
                                                        {{ __('Intermediárias') }}
                                                ...
                                                @if ($proposal->unit->intermediate_start_1 != null)
                                                    <div class="col-span-12 md:col-start-1 md:col-span-1">
                                                        <h1
                                                            class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                            {{ __('Pagamentos') }}
                                                        </h1>
                                                    ...
                                                    <div class="col-span-12 md:col-span-2">
                                                        ...
                                                        <x-input id="cash_value"
                                                            class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                            type="text" name="cash_value" disabled
                                                            :value="'R$ ' . number_format($proposal->unit->pre_keys_intermediate_value, 2, ',', '.')" />
                                                    </div>
                                                    <div class="col-span-12 md:col-span-2">
                                                        <h1
                                                            class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                        ...
                                                        <x-input id="cash_date"
                                                            class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500"
                                                            type="text" name="cash_date"
                                                            :value="$proposal->unit->intermediate_start_1?->format('m/Y')"
                                                            disabled />
                                                    </div>
                                                @endif
                                                @if ($proposal->unit->intermediate_start_2 != null)
                                                    ...
                                                    <div class="col-span-12 md:col-span-2">
                                                        ...
                                                        <x-input id="cash_date"
                                                            class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500"
                                                            type="text" name="cash_date"
                                                            :value="$proposal->unit->intermediate_start_2?->format('m/Y')"
                                                            disabled />
                                                    </div>
                                                @endif
                                                @if ($proposal->unit->intermediate_start_3 != null)
                                                    ...
                                                    <div class="col-span-12 md:col-span-2">
                                                        ...
                                                        <x-input id="cash_date"
                                                            class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500"
                                                            type="text" name="cash_date"
                                                            :value="$proposal->unit->intermediate_start_3?->format('m/Y')"
                                                            disabled />
                                                    </div>
                                                @endif
                                                @if ($proposal->unit->intermediate_start_4 != null)
                                                    ...
                                                    <div class="col-span-12 md:col-span-2">
                                                        ...
                                                        <x-input id="cash_date"
                                                            class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500"
                                                            type="text" name="cash_date"
                                                            :value="$proposal->unit->intermediate_start_4?->format('m/Y')"
                                                            disabled />
                                                    </div>
                                                @endif
                                                @if ($proposal->unit->intermediate_start_5 != null)
                                                    ...
                                                    <div class="col-span-12 md:col-span-2">
                                                        ...
                                                        <x-input id="cash_date"
                                                            class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500"
                                                            type="text" name="cash_date"
                                                            :value="$proposal->unit->intermediate_start_5?->format('m/Y')"
                                                            disabled />
                                                    </div>
                                                @endif
                                                @if ($proposal->unit->intermediate_start_6 != null)
                                                    ...
                                                    <div class="col-span-12 md:col-span-2">
                                                        ...
                                                        <x-input id="cash_date"
                                                            class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500"
                                                            type="text" name="cash_date"
                                                            :value="$proposal->unit->intermediate_start_6?->format('m/Y')"
                                                            disabled />
                                                    </div>
                                                @endif
                                            @endif
                                            ...
                                            <div class="col-span-12 md:col-span-2">
                                                <h1
                                                    class="mt-2 text-sm font-bold text-justify text-gray-700 uppercase">
                                                    {{ __('Valor total de pré-chaves') }}
                                                </h1>
                                                <x-input id="cash_value"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="text" name="cash_value" disabled
                                                    :value="'R$ ' . number_format( $proposal->unit->getTotalPreKeysValue() , 2, ',', '.')" />
                                            </div>
                                            <div class="col-span-12">
                                                <h1 class="mt-6 font-bold text-left text-gray-500 uppercase text-md">
                                                    {{ __('Financiamento') }} <strong
                                                        class="font-bold text-red-700">{{ $proposal->unit->getTranslatedFinancingType() }}</strong>
                                                </h1>
                                            </div>
                                            @if ($proposal->unit->financing_monthly_qty > 0)
                                                ...
                                                <div class="col-span-12 md:col-span-1">
                                                    ...
                                                    <x-input id="cash_installments"
                                                        class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                        type="text" name="cash_installments" disabled
                                                        :value="$proposal->unit->financing_monthly_qty" />
                                                </div>
                                                <div class="col-span-12 md:col-span-2">
                                                    <h1
                                                        class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                    ...
                                                    <x-input id="cash_value"
                                                        class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                        type="text" name="cash_value" disabled
                                                        :value="'R$ ' . number_format($proposal->unit->financing_monthly_value, 2, ',', '.')" />
                                                </div>
                                                <div class="col-span-12 md:col-span-2">
                                                    <h1
                                                        class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                    ...
                                                    <x-input id="cash_date"
                                                        class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500"
                                                        type="text" name="cash_date"
                                                        :value="$proposal->unit->financing_monthly_start?->format('m/Y')"
                                                        disabled />
                                                </div>
                                            @endif
                                            @if ($proposal->unit->financing_yearly_qty > 0)
                                                ...
                                                <div class="col-span-12 md:col-span-1">
                                                    ...
                                                    <x-input id="cash_installments"
                                                        class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                        type="text" name="cash_installments" disabled
                                                        :value="$proposal->unit->financing_yearly_qty" />
                                                </div>
                                                <div class="col-span-12 md:col-span-2">
                                                    <h1
                                                        class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                    ...
                                                    <x-input id="cash_value"
                                                        class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                        type="text" name="cash_value" disabled
                                                        :value="'R$ ' . number_format($proposal->unit->financing_yearly_value, 2, ',', '.')" />
                                                </div>
                                                <div class="col-span-12 md:col-span-2">
                                                    <h1
                                                        class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                    ...
                                                    <x-input id="cash_date"
                                                        class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500"
                                                        type="text" name="cash_date"
                                                        :value="$proposal->unit->financing_yearly_start?->format('m/Y')"
                                                        disabled />
                                                </div>
                                            @endif
                                            <hr class="col-span-12 mt-6 mb-2" />
                                    ...
                                    <!-- custom payment -->
                                    <div class="px-6 pt-2 pb-6" id="div_custom" style="display: none;">
                                        <div class="grid grid-cols-12 gap-4 mb-4">
                                            <div class="col-span-12">
                                                <h1 class="mt-4 text-lg font-bold text-left text-gray-700 uppercase">
                                                    {{ __('Fluxo pré-chaves') }}
                                            ...
                                            <div class="col-span-12 md:col-span-1">
                                                ...
                                                <x-input id="custom_cash_installments"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="number" name="custom_cash_installments" :value="1" />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1
                                                    class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                ...
                                                <x-input id="custom_cash_value"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="number" name="custom_cash_value"
                                                    :value="number_format($proposal->unit->inflow, 2, ',')" />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1
                                                    class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                ...
                                                <x-input id="custom_cash_date"
                                                    class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="text" name="custom_cash_date" data-mask="00/0000"
                                                    :value="$proposal->unit->pre_keys_spot_month?->format('m/Y')" />
                                            </div>
                                            <div class="col-span-12">
                                                <h1 class="mt-4 font-bold text-left text-gray-500 uppercase text-md">
                                            ...
                                            <div class="col-span-12 md:col-span-1">
                                                ...
                                                <x-input id="custom_pre_monthly_installments"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="number" name="custom_pre_monthly_installments"
                                                    :value="$proposal->unit->pre_keys_monthly_qty" />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1
                                                ...
                                                <x-input id="custom_pre_montlhy_value"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="number" name="custom_pre_montlhy_value"
                                                    :value="number_format($proposal->unit->pre_keys_monthly_value, 2, ',')" />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1
                                                    class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                ...
                                                <x-input id="custom_pre_monthly_date"
                                                    class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="text" name="custom_pre_monthly_date" data-mask="00/0000"
                                                    :value="$proposal->unit->pre_keys_monthly_start?->format('m/Y')" />
                                            </div>
                                            <div class="col-span-12">
                                                <h1 class="mt-4 font-bold text-left text-gray-500 uppercase text-md">
                                            ...
                                            <div class="col-span-12 md:col-start-1 md:col-span-1">
                                                ...
                                                <x-input id="custom_intermadiate_installments1"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="number" name="custom_intermadiate_installments1" />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1
                                                    class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                ...
                                                <x-input id="custom_intermadiate_value1"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="number" name="custom_intermadiate_value1"
                                                    :value="number_format($proposal->unit->pre_keys_intermediate_value, 2, ',')" />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1
                                                    class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                ...
                                                <x-input id="custom_intermadiate_date1"
                                                    class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="text" name="custom_intermadiate_date1" data-mask="00/0000"
                                                    :value="$proposal->unit->intermediate_start_1?->format('m/Y')" />
                                            </div>
                                            <div class="col-span-12 md:col-start-1 md:col-span-1">
                                                <h1
                                                ...
                                                <x-input id="custom_intermadiate_installments2"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="number" name="custom_intermadiate_installments2" />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1
                                                    class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                ...
                                                <x-input id="custom_intermadiate_value2"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="number" name="custom_intermadiate_value2"
                                                    :value="number_format($proposal->unit->pre_keys_intermediate_value, 2, ',', '.')" />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1
                                                ...
                                                <x-input id="custom_intermadiate_date2"
                                                    class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="text" name="custom_intermadiate_date2" data-mask="00/0000"
                                                    :value="$proposal->unit->intermediate_start_2?->format('m/Y')" />
                                            </div>
                                            <div class="col-span-12 md:col-start-1 md:col-span-1">
                                                <h1
                                                ...
                                                <x-input id="custom_intermadiate_installments3"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="number" name="custom_intermadiate_installments3" />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1
                                                    class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                ...
                                                <x-input id="custom_intermadiate_value3"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="number" name="custom_intermadiate_value3"
                                                    :value="number_format($proposal->unit->pre_keys_intermediate_value, 2, ',', '.')" />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1
                                                ...
                                                <x-input id="custom_intermadiate_date3"
                                                    class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="text" name="custom_intermadiate_date3" data-mask="00/0000"
                                                    :value="$proposal->unit->intermediate_start_3?->format('m/Y')" />
                                            </div>
                                            <div class="col-span-12 md:col-start-1 md:col-span-1">
                                                <h1
                                                ...
                                                <x-input id="custom_intermadiate_installments4"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="number" name="custom_intermadiate_installments4" />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1
                                                    class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                ...
                                                <x-input id="custom_intermadiate_value4"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="number" name="custom_intermadiate_value4"
                                                    :value="number_format($proposal->unit->pre_keys_intermediate_value, 2, ',', '.')" />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1
                                                ...
                                                <x-input id="custom_intermadiate_date4"
                                                    class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="text" name="custom_intermadiate_date4" data-mask="00/0000"
                                                    :value="$proposal->unit->intermediate_start_4?->format('m/Y')" />
                                            </div>
                                            <div class="col-span-12 md:col-start-1 md:col-span-1">
                                                <h1
                                                ...
                                                <x-input id="custom_intermadiate_installments5"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="number" name="custom_intermadiate_installments5" />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1
                                                    class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                ...
                                                <x-input id="custom_intermadiate_value5"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="number" name="custom_intermadiate_value5"
                                                    :value="number_format($proposal->unit->pre_keys_intermediate_value, 2, ',', '.')" />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1
                                                ...
                                                <x-input id="custom_intermadiate_date5"
                                                    class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="text" name="custom_intermadiate_date5" data-mask="00/0000"
                                                    :value="$proposal->unit->intermediate_start_5?->format('m/Y')" />
                                            </div>
                                            <div class="col-span-12 md:col-start-1 md:col-span-1">
                                                <h1
                                                ...
                                                <x-input id="custom_intermadiate_installments6"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="number" name="custom_intermadiate_installments6" />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1
                                                    class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                ...
                                                <x-input id="custom_intermadiate_value6"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="number" name="custom_intermadiate_value6"
                                                    :value="number_format($proposal->unit->pre_keys_intermediate_value, 2, ',', '.')" />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1
                                                ...
                                                <x-input id="custom_intermadiate_date6"
                                                    class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="text" name="custom_intermadiate_date6" data-mask="00/0000"
                                                    :value="$proposal->unit->intermediate_start_6?->format('m/Y')" />
                                            </div>
                                            <div class="col-span-12">
                                                <h1 class="mt-6 font-bold text-left text-gray-500 uppercase text-md">
                                            ...
                                            <div class="col-span-12 md:col-span-2">
                                                ...
                                                <x-input id="custom_pre_keys_total_value"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="number" name="custom_pre_keys_total_value" disabled
                                                    :value="number_format( $proposal->unit->getTotalPreKeysValue() , 2, ',', '.')" />
                                            </div>
                                            <div class="col-span-12">
                                                <h1 class="mt-6 font-bold text-left text-gray-500 uppercase text-md">
                                                    {{ __('Financiamento') }} <strong
                                            ...
                                            <div class="col-span-12 md:col-span-1">
                                                ...
                                                <x-input id="custom_loan_monthly_installments"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="number" name="custom_loan_monthly_installments"
                                                    :value="$proposal->unit->financing_monthly_qty" />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1
                                                ...
                                                <x-input id="custom_loan_monthly_value"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="number" name="custom_loan_monthly_value"
                                                    :value="number_format($proposal->unit->financing_monthly_value, 2, ',', '.')" />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1
                                                    class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                ...
                                                <x-input id="custom_loan_monthly_date"
                                                    class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="text" name="custom_loan_monthly_date" data-mask="00/0000"
                                                    :value="$proposal->unit->financing_monthly_start?->format('m/Y')" />
                                            </div>
                                            <div class="col-span-12">
                                                <h1 class="mt-4 font-bold text-left text-gray-500 uppercase text-md">
                                            ...
                                            <div class="col-span-12 md:col-span-1">
                                                ...
                                                <x-input id="custom_loan_yearly_installments"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="number" name="custom_loan_yearly_installments"
                                                    :value="$proposal->unit->financing_yearly_qty" />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1
                                                ...
                                                <x-input id="custom_loan_yearly_value"
                                                    class="block w-full mt-1 uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="number" name="custom_loan_yearly_value"
                                                    :value="number_format($proposal->unit->financing_yearly_value, 2, ',', '.')" />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                <h1
                                                    class="mt-4 text-sm font-bold text-justify text-gray-700 uppercase">
                                                ...
                                                <x-input id="custom_loan_yearly_date"
                                                    class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="text" name="custom_loan_yearly_date" data-mask="00/0000"
                                                    :value="$proposal->unit->financing_yearly_start?->format('m/Y')" />
                                            </div>
                                            <hr class="col-span-12 mt-6 mb-2" />
                                        </div>
                                    </div>
                                    <div class="px-6 mb-12" id="gdpr_text" style="display: none;">
                                        {!! $proposal->product->gdprs->where('type', 'proposal')->first()?->content !!}
                                        <p class="mt-8 font-bold">Ao clicar em enviar, você concorta e aceita os termos
                                            acima.</p>
                                    </div>
                                    <div class="px-4 py-8 text-center bg-gray-50 sm:px-6">
                                        <button type="submit" style="display: none;" id="button_submit"
                                        ...
                                        <div class="mt-4 text-xs" id="legal_text" style="display: none;">
                                            {!! $proposal->product->gdprs->where('type', 'legal_text')->first()?->content ?? 'Termos não disponíveis' !!}</div>
                                    </div>
                                </div>
                            </form>
                        </section>
                        ...
                        <div class="my-4">
                            <div class="grid grid-cols-8 gap-6 gap-y-2">
                                ...
                                <div class="col-span-8 sm:col-span-8">
                                    ...
                                    <textarea name="message" id="message" rows="3" placeholder="Escreva aqui o motivo de sua solicitação"
