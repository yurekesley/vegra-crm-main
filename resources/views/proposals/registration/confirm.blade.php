                                    ...
                                    <div class="p-6">
                                        <div class="grid grid-cols-12 gap-4 mb-4">
                                            <div class="col-span-12 md:col-span-3 md:col-start-3">
                                                <h1 class="mt-4 text-lg font-bold text-justify text-gray-700 uppercase">
                                                    {{ __('Informe o código de participação') }}
                                                </h1>
                                                <x-input id="code"
                                                    class="block w-full mt-1 text-center uppercase disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="text" name="code" disabled
                                                    :value="old('code') ?? $code?->code" maxlength="8" />
                                            </div>
                                            <div class="col-span-12 md:col-span-3">
                                                ...
                                                <x-input id="name"
                                                    ...
                                                    type="text" name="name" :value="$code->prospect->name" disabled />
                                            </div>
                                            <div class="col-span-12 md:col-span-2">
                                                ...
                                                <x-input id="incoming"
                                                    class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="text" name="incoming"
                                                    :value="$code->prospect != null ? 'R$ ' . $code->prospect->total_incoming : ''"
                                                    disabled />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="px-4 py-8 text-center bg-gray-50 sm:px-6">
                                        <a href="{{ route('proposals.registration.mirror', ['product' => $product->id, 'code' => $code->id]) }}"
                                            ...
                                            {{ __('Abrir espelho de vendas digital') }}
                                        </a>
