                            ...
                            <div class="overflow-hidden bg-white rounded-lg shadow-md">
                                <div class="p-6">
                                    <div class="flex justify-center px-4 mx-auto mb-8 sm:px-6 lg:px-8">
                                        <img src="{{ $prospect->product->logo_url }}"
                                            alt="Logo {{ $prospect->product->name }}">
                                    </div>
                                </div>
                                <hr class="col-span-6 mx-4 mb-4" />
                                <div class="flex flex-col items-center py-5 bg-white">
                                    <form method="POST" enctype="multipart/form-data"
                                        action="{{ route('prospects.data.documents.store', ['code' => $prospect->document_code, 'timestamp' => time()]) }}"
                                                        ...
                                                        <label
                                                            ...
                                                            <div
                                                                ...
                                                                <p
                                                                    ...
                                                                    CPF ou CNH</p>
                                                                <p id="label_cpf_cnh"
                                                                    class="pt-1 text-xs tracking-wider text-red-400 group-hover:text-red-600">
