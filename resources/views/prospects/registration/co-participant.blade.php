                        ...
                        <section aria-labelledby="section-1-title">
                            ...
                            <div class="overflow-hidden bg-white rounded-lg shadow-md">
                                ...
                                <div class="flex flex-col items-center py-5 bg-white">
                                    <form method="POST"
                                        action="{{ route('prospects.registration.co-participant.store', ['product' => $product->id,'prospect' => $prospect->id,'timestamp' => time()]) }}"
                                            ...
                                            <div class="grid w-full grid-cols-12 gap-4 md:max-w-7xl lg:max-w-6xl">
                                                ...
                                                <div class="col-span-12 md:col-span-4">
                                                    ...
                                                    <x-input id="name" class="block w-full mt-1" type="text" name="name"
                                                        :value="old('name') ?? $prospect->copart_name" required autofocus
                                                ...
                                                <div class="col-span-12 md:col-span-3">
                                                    ...
                                                    <x-input id="cpf_cnpj" class="block w-full mt-1" type="text"
                                                        name="cpf_cnpj" :value="old('cpf_cnpj') ?? $prospect->copart_cpf_cnpj"
                                                        required placeholder="Informar apenas números" />
                                                </div>
                                                ...
                                                <div class="col-span-12 md:col-span-3">
                                                    ...
                                                    <x-input id="phone" class="block w-full mt-1" type="text"
                                                        name="phone" :value="old('phone') ?? $prospect->copart_phone" required
                                            ...
                                            <div class="grid w-full grid-cols-12 gap-4 mt-4 md:max-w-7xl lg:max-w-6xl">
                                                ...
                                                <div class="col-span-12 md:col-span-4">
                                                    ...
                                                    <x-input id="email" class="block w-full mt-1" type="email"
                                                        name="email" :value="$prospect->copart_email" required
                                                        placeholder="Informe o email do cônjuge / coparticipante" />
                                                </div>
                                                ...
                                                <div class="col-span-12 md:col-span-4">
                                                    ...
                                                    <x-input id="occupation" class="block w-full mt-1" type="text"
                                                        name="occupation" :value="old('occupation') ?? $prospect->copart_occupation"
                                                ...
                                                <div class="col-span-12 md:col-span-4">
                                                    ...
                                                    <select name="marital_state" id="marital_state"
                                                        class="mt-1 block w-full pl-3 h-[42px] pr-10 py-2 text-bas border-gray-300 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm rounded-md disabled:bg-gray-200 disabled:text-gray-500">
                                        ...
                                        <div class="w-full px-4 py-8 text-center bg-gray-50 sm:px-6">
                                            <a href="{{ route('prospects.registration.documents', ['product' => $product->id, 'prospect' => $prospect->id]) }}"
    ...
    <script>
        ...
        $('#has_coparticipant').on('change', function() {
            if ($("#has_coparticipant option:selected").val() == 'true') {
                ...
                $('#marital_state').prop('disabled', false);
            } else {
                ...
                $('#marital_state').prop('disabled', true);
                $('#name').val('');
                $('#email').val('');
                $('#cpf_cnpj').val('');
                $('#phone').val('');
