                    ...
                    <div class="grid grid-cols-1 col-span-12 gap-4 mt-4 md:col-span-10 md:col-start-2">
                        ...
                        <section aria-labelledby="section-1-title">
                            ...
                            <div class="overflow-hidden bg-white rounded-lg shadow-md">
                                ...
                                <form method="POST"
                                    action="{{ route('prospects.registration.check-broker', [$product->id, 'timestamp' => time()]) }}"
                                    class="w-full">
                                    @csrf
                                    <div class="p-6">
                                        <hr class="px-4" />
                                        <div class="grid grid-cols-3">
                                            <div class="col-span-3 md:col-span-1 md:col-start-2">
                                                <h1 class="mt-4 text-lg font-bold text-justify text-gray-700 uppercase">
                                                    {{ __('Informe o email do corretor') }}
                                                </h1>
                                                <x-input id="broker_email"
                                                    class="block w-full mt-1 disabled:bg-gray-200 disabled:text-gray-500"
                                                    type="email" name="broker_email" :value="old('broker_email')" />
                                            </div>
                                        </div>
                                        @if ($product->allow_customer_without_broker)
                                            <div class="flex justify-center mt-3">
                                                <label for="havent_broker" class="inline-flex items-center">
                                                    <input id="havent_broker" type="checkbox"
                                                        ...
                                                        name="havent_broker">
                                                    <span
                                                        class="ml-2 text-lg">{{ __('Não possuo corretor') }}</span>
                                                </label>
                                            </div>
                                        @endif
