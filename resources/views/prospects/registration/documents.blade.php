                            ...
                            <div class="overflow-hidden bg-white rounded-lg shadow-md">
                                ...
                                <div class="flex flex-col items-center py-5 bg-white">
                                    <form method="POST" enctype="multipart/form-data"
                                        action="{{ route('prospects.registration.documents.store', ['product' => $product->id,'prospect' => $prospect->id,'timestamp' => time()]) }}"
                                                        ...
                                                        <label
                                                            ...
                                                            <div
                                                                ...
                                                                <p id="label_cpf_cnh"
                                                                    ...
                                                                    {{ basename($prospect->prospect_documents->where('type', 'cpf_cnh')->first()?->url ?? '') }}
                                                                </p>
                                                            </div>
                                                    ...
                                                    <div class="flex items-center justify-center w-full">
                                                        <label
                                                            ...
                                                            <div
                                                                ...
                                                                <p id="label_rg"
                                                                    class="pt-1 text-sm tracking-wider text-red-400 group-hover:text-red-600">
                                                                    {{ basename($prospect->prospect_documents->where('type', 'rg')->first()?->url ?? '') }}
                                                                </p>
                                                            </div>
                                                    ...
                                                    <div class="flex items-center justify-center w-full">
                                                        <label
                                                            ...
                                                            <div
                                                                ...
                                                                <p
                                                                    class="pt-1 text-sm tracking-wider text-gray-400 group-hover:text-gray-600">
                                                                    Comprovante de residência em nome do cliente
                                                                    (últimos 3 meses)</p>
                                                                <p id="label_comp_res"
                                                                    class="pt-1 text-sm tracking-wider text-red-400 group-hover:text-red-600">
                                                                    {{ basename($prospect->prospect_documents->where('type', 'comp_res')->first()?->url ?? '') }}
                                                                </p>
                                                            </div>
                                                        ...
                                                        <label
                                                            ...
                                                            <div
                                                                ...
                                                                <p id="label_comp_est_civil"
                                                                    class="pt-1 text-sm tracking-wider text-red-400 group-hover:text-red-600">
                                                                    {{ basename($prospect->prospect_documents->where('type', 'com_est_civil')->first()?->url ?? '') }}
                                                                </p>
                                                            </div>
                                                        ...
                                                        <label
                                                            ...
                                                            <div
                                                                ...
                                                                <p id="label_advb_est_civil"
                                                                    class="pt-1 text-sm tracking-wider text-red-400 group-hover:text-red-600">
                                                                    {{ basename($prospect->prospect_documents->where('type', 'advb_est_civil')->first()?->url ?? '') }}
                                                                </p>
                                                            </div>
                                                        ...
                                                        <label
                                                            ...
                                                            <div
                                                                ...
                                                                <p id="label_com_renda"
                                                                    class="pt-1 text-sm tracking-wider text-red-400 group-hover:text-red-600">
                                                                    {{ basename($prospect->prospect_documents->where('type', 'com_renda')->first()?->url ?? '') }}
                                                                </p>
                                                            </div>
                                                    ...
                                                    <div class="flex items-center justify-center w-full">
                                                        <label
                                                            ...
                                                            <div
                                                                ...
                                                                <p id="label_other"
                                                                    class="pt-1 text-sm tracking-wider text-red-400 group-hover:text-red-600">
                                                                    {{ basename($prospect->prospect_documents->where('type', 'other')->first()?->url ?? '') }}
                                                                </p>
                                                            </div>
