                ...
                <div class="grid items-center grid-cols-12 gap-4">
                    <div class="grid grid-cols-1 col-span-12 gap-4 mt-4 md:col-span-10 md:col-start-2">
                        <section aria-labelledby="section-header-navigation mb-4">
                            <x-registration-step :step="6" :has_coparticipant="$prospect->has_coparticipant" />
                        </section>
                            ...
                            <div class="overflow-hidden bg-white rounded-lg shadow-md">
                                <div class="p-6">
                                    ...
                                    <p class="text-lg text-justify text-gray-500">
                                        ...
                                        crédito do cliente na compra de uma unidade no empreendimento
                                ...
                                <div class="flex flex-col items-center py-5 bg-white">
                                    <form method="POST" class="flex flex-col w-full">
                                        ...
                                        <div
                                            ...
                                            <h2
                                                class="col-span-6 mb-8 text-3xl font-semibold leading-tight text-gray-600">
                                                {{ __('Revise seus dados antes de enviar') }}
                                            </h2>
                                            <h2
                                                class="col-span-6 mt-6 mb-4 text-xl font-semibold leading-tight text-gray-600">
                                                {{ __('Corretor') }}
                                            </h2>
                                            <div class="grid w-full grid-cols-12 gap-4 md:max-w-7xl lg:max-w-6xl">
                                                @if ($prospect->has_broker)
                                                    <div class="col-span-12 md:col-span-4 md:col-start-3">
                                                        <x-label for="broker_name" :value="__('Corretor')" />

                                                        <x-input id="broker_name"
                                                            class="block w-full mt-1 disabled:bg-gray-100 disabled:text-gray-700"
                                                            type="text" name="broker_name"
                                                            :value="old('broker_name') ?? $prospect->broker->name"
                                                            required disabled />
                                                    </div>
                                                    <div class="col-span-12 md:col-span-4">
                                                        <x-label for="broker_email" :value="__('Email do corretor')" />

                                                        <x-input id="broker_email"
                                                            class="block w-full mt-1 disabled:bg-gray-100 disabled:text-gray-700"
                                                            type="text" name="broker_email"
                                                            :value="old('broker_email') ?? $prospect->broker->email"
                                                            required disabled />
                                                    </div>
                                                @else
                                                    <div class="col-span-12 md:col-span-4 md:col-start-3">
                                                        ...
                                                        <x-input id="broker_name"
                                                            class="block w-full mt-1 disabled:bg-gray-100 disabled:text-gray-700"
                                                            type="text" name="broker_name" :value="'Não informado'"
                                                            required disabled />
                                                    </div>
                                                    <div class="col-span-12 md:col-span-4">
                                                        <x-label for="broker_email" :value="__('Email do corretor')" />
                                                        ...
                                                        <x-input id="broker_email"
                                                            class="block w-full mt-1 disabled:bg-gray-100 disabled:text-gray-700"
                                                            type="text" name="broker_email" :value="'Não informado'"
                                                            required disabled />
                                                    </div>
                                                @endif
                                            </div>
                                            <hr class="w-full mt-12 mb-4">
                                            <h2
                                            ...
                                            <div class="grid w-full grid-cols-12 gap-4 md:max-w-7xl lg:max-w-6xl">
                                                <div class="col-span-12 md:col-span-4">
                                                    ...
                                                    <x-input id="name"
                                                        class="block w-full mt-1 disabled:bg-gray-100 disabled:text-gray-700"
                                                        type="text" name="name" :value="old('name') ?? $prospect->name"
                                            ...
                                            <div class="grid w-full grid-cols-12 gap-4 mt-4 md:max-w-7xl lg:max-w-6xl">
                                                ...
                                                <div class="col-span-12 md:col-span-4">
                                                    ...
                                                    <x-input id="email"
                                                        ...
                                                        :value="old('email') ?? $prospect->email" required disabled />
                                                </div>
                                                ...
                                                <div class="col-span-12 md:col-span-4">
                                                    ...
                                                    <x-input id="occupation"
                                                        ...
                                                        :value="old('occupation') ?? $prospect->occupation" required
                                                        disabled />
                                                </div>
                                                ...
                                                <div class="col-span-12 md:col-span-4">
                                                    ...
                                                    <select name="marital_state" id="marital_state" disabled
                                                        ...
                                                        <option @if ($prospect->marital_state == 'single') selected @endif
                                                            value="single" )>Solteiro(a)
                                                        </option>
                                                        <option @if ($prospect->marital_state == 'married') selected @endif
                                                            value="married" )>Casado(a)
                                                        </option>
                                                        <option @if ($prospect->marital_state == 'divorced') selected @endif
                                                            value="divorced" )>
                                                            Divorciado(a)
                                                        </option>
                                                        <option @if ($prospect->marital_state == 'widowed') selected @endif
                                                            value="widowed" )>Viúvo(a)
                                                        </option>
                                                        <option @if ($prospect->marital_state == 'undefined') selected @endif
                                                            value="undefined" )>Não
                                                            definido
                                                        </option>
                                                    </select>
                                            ...
                                            <div class="grid w-full grid-cols-12 gap-4 mt-4 md:max-w-7xl lg:max-w-6xl">
                                                <div class="col-span-12">
                                                    ...
                                                    <textarea name="preferences" id="preferences" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm disabled:bg-gray-100 disabled:text-gray-700 focus:ring-red-500 focus:border-red-500 sm:text-sm"
                                                        autofocus rows="5"
                                                        disabled>{{ $prospect->customer_preferences }}</textarea>
                                                    @error('preferences')
                                                        <small class="text-red-700 font-sm">*{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                ...
                                                @foreach ($prospect->prospect_documents as $prospect_document)
                                                    <div class="col-span-12 md:col-span-3">
                                                        <div class="flex items-center justify-center w-full">
                                                            <label
                                                                class="flex flex-col w-full h-32 hover:bg-gray-100 hover:border-gray-300">
                                                                <div
                                                                    ...
                                                                    <svg version="1.1"
                                                                        ...
                                                                        x="0px" width="32" height="32" fill="gray"
                                                        ...
                                                        @error('comp_res')
                                                            <small
                                                                class="text-red-700 font-sm">*{{ $message }}</small>
                                                        @enderror
                                                    </div>
                                                @endforeach
                                            </div>
                                            ...
                                            <div class="grid w-full grid-cols-12 gap-4 md:max-w-7xl lg:max-w-6xl">
                                                <div class="col-span-6 md:col-span-2">
                                                    ...
                                                    <select name="has_coparticipant" id="has_coparticipant" disabled
                                                        ...
                                                        <option value="true"
                                                            @if (old('has_coparticipant') ?? $prospect->has_coparticipant) selected @endif>Sim
                                                        </option>
                                                        <option value="false"
                                                            @if (old('has_coparticipant') ?? !$prospect->has_coparticipant) selected @endif>Não
                                                        </option>
                                                    </select>
                                                ...
                                                <div class="col-span-12 md:col-span-4">
                                                    ...
                                                    <x-input id="name"
                                                        class="block w-full mt-1 disabled:bg-gray-100 disabled:text-gray-700"
                                                        type="text" name="name"
                                                        :value="old('name') ?? $prospect->copart_name" required
                                                        autofocus disabled />
                                                </div>
                                                <!-- CPF -->
                                                <div class="col-span-12 md:col-span-3">
                                                    ...
                                                    <x-input id="cpf_cnpj"
                                                        class="block w-full mt-1 disabled:bg-gray-100 disabled:text-gray-700"
                                                        type="text" name="cpf_cnpj"
                                                        :value="old('cpf_cnpj') ?? $prospect->copart_cpf_cnpj" required
                                                        disabled />
                                                </div>
                                                ...
                                                <div class="col-span-12 md:col-span-3">
                                                    ...
                                                    <x-input id="phone"
                                                        class="block w-full mt-1 disabled:bg-gray-100 disabled:text-gray-700"
                                                        type="text" name="phone" :value="$prospect->copart_phone"
                                                        required disabled />
                                                </div>
                                            </div>
                                            <div class="grid w-full grid-cols-12 gap-4 mt-4 md:max-w-7xl lg:max-w-6xl">
                                                ...
                                                <div class="col-span-12 md:col-span-4">
                                                    ...
                                                    <x-input id="email"
                                                        class="block w-full mt-1 disabled:bg-gray-100 disabled:text-gray-700"
                                                        type="email" name="email"
                                                        :value="old('email') ?? $prospect->copart_email" required
                                                        disabled />
                                                </div>
                                                ...
                                                <div class="col-span-12 md:col-span-4">
                                                    ...
                                                    <x-input id="occupation"
                                                        class="block w-full mt-1 disabled:bg-gray-100 disabled:text-gray-700"
                                                        type="text" name="occupation"
                                                        :value="old('occupation') ?? $prospect->copart_occupation"
                                                        required disabled />
                                                </div>
                                                ...
                                                <div class="col-span-12 md:col-span-4">
                                                    ...
                                                    <select name="marital_state" id="marital_state" disabled
                                                        class="mt-1 block w-full pl-3 h-[42px] pr-10 py-2 text-bas border-gray-300 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm rounded-md disabled:bg-gray-100 disabled:text-gray-700">
                                                        <option @if ($prospect->copart_marital_state == 'single') selected @endif
                                                            value="single" )>Solteiro(a)
                                                        </option>
                                                        <option @if ($prospect->copart_marital_state == 'married') selected @endif
                                                            value="married" )>Casado(a)
                                                        </option>
                                                        <option @if ($prospect->copart_marital_state == 'divorced') selected @endif
                                                            value="divorced" )>
                                                            Divorciado(a)
                                                        </option>
                                                        <option @if ($prospect->copart_marital_state == 'widowed') selected @endif
                                                            value="widowed" )>Viúvo(a)
                                                        </option>
                                                        <option @if ($prospect->copart_marital_state == 'undefined') selected @endif
                                                            value="undefined" )>Não
                                                            definido
                                                        </option>
                                                        <option @if ($prospect->copart_marital_state == null) selected @endif
                                                            value="null" )>
                                                        </option>
                                                    </select>
                                                    @error('marital_state')
                                        ...
                                        <div class="w-full gap-4 px-4 py-8 text-center bg-gray-50 sm:px-6">
                                            <a href="{{ $prospect->has_coparticipant? route('prospects.registration.co-participant.documents', ['product' => $product->id, 'prospect' => $prospect->id]): route('prospects.registration.co-participant', ['product' => $product->id, 'prospect' => $prospect->id]) }}"
                                                ...
                                                {{ __('Voltar') }}</a>
                                            <a href="{{ route('prospects.registration.terms', ['product' => $product->id, 'prospect' => $prospect->id]) }}"
